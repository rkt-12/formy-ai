...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 flex h-16 px-4 md:px-6 items-center gap-4 !bg-[#43217c]">
      <nav className="gap-6 h-full justify-between text-lg font-medium flex flex-row w-full">
